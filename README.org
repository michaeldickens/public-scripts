This repository includes scripts too small for their own repos. Any undocumented scripts are incomplete. Even many of the documented ones are incomplete or rough.
