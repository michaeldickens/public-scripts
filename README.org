This repository includes scripts too small for their own repos. Some of the scripts are not documented because they're too incomplete to do anything useful yet.
